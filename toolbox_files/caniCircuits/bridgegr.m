function bridgegr()
%bridge rectifier, with simple ideal diode model (0.7 V drop), and, unlike "bridger.m",
%ground is on load, not on input.

%Copyright 2002, Charles R. Sullivan
%Version 1.1, Jan., 2002
%Conv to 1.2 June 2002
...
vm = [z z z z Vrleft Vrright  vin vin vin] - Vrright*ones(1,9);
...
view([ 60, 35]);  % azimuth and elevation
